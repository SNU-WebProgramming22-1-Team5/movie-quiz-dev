    ...
    <Wrap>
      ...
      <>
        ...
        <Gold>
          ...
          <div>{scores[0].email.split('@')[0]}</div><div>{rank==="Score"?scores[0].bestScore:exp[0].EXP}</div>
        </Gold>
        <Silver>
          <img alt="GoogleLogin" src={process.env.PUBLIC_URL +'/img/silver.png'}></img>
          <div>{scores[1].email.split('@')[0]}</div><div>{rank==="Score"?scores[1].bestScore:exp[1].EXP}</div>
        </Silver>
        <Ddong>
          <img alt="GoogleLogin" src={process.env.PUBLIC_URL +'/img/ddong.png'}></img>
          <div>{scores[2].email.split('@')[0]}</div><div>{rank==="Score"?scores[2].bestScore:exp[2].EXP}</div>
        </Ddong>
        <BottomBox>
          {rank==="Score"?
            <>
